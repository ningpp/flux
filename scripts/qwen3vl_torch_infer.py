"""
Qwen3-VL-2B-Instruct Torch Inference (reference implementation).
Run: D:\\conda\\envs\\qwen3vlonnx\\python scripts\\qwen3vl_torch_infer.py

Uses transformers >= 5.0 Qwen3VLForConditionalGeneration.
...
def main():
    print("=" * 60)
    print("Qwen3-VL-2B-Instruct  —  Torch Inference (greedy)")
    print("=" * 60)
    ...
    print(f"input_ids[:30] = {input_ids[0, :30].tolist()}")
    ...
    print(f"All generated token IDs: {new_ids.tolist()}")
    print(f"\n--- GENERATED TEXT ---")
    print(text)
    print(f"--- END ---")
